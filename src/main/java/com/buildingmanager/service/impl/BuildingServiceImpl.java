...
//	}
//
//	private List<BuildingSearchResponse> toListBuildingDTO(List<BuildingEntityCustom> listBuildingEntity) {
//		List<BuildingSearchResponse> listBuilding = null;
//		
//		if (listBuildingEntity != null) {
//			listBuilding = new ArrayList<BuildingSearchResponse>();
//			for (BuildingEntityCustom buildingEntity : listBuildingEntity) {
