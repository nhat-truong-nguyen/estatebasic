...
public class BuildingController {
	...
	@Autowired BuildingConverter buildingConverter;
	
	@GetMapping("/admin/building-list")
	public ModelAndView buildingSearchForm() {
		ModelAndView mav = new ModelAndView("admin/building-search");
		mav.addObject("districts", DistrictEnum.values())
		   .addObject("rentTypes", BuildingTypeEnum.values())
		   .addObject("staffs", userService.findAllStaff())
		   .addObject("buildings", buildingService.findAll());
		return mav;
	}
	
	@GetMapping("/admin/building-search")
	public ModelAndView buildingSearchList(@RequestParam Map<String, String> params, @RequestParam("rentType") List<String> rentTypes) {
		ModelAndView mav = new ModelAndView("admin/building-search");
	...
	public ModelAndView assignBuilding(@RequestParam("staffIds") Long[] staffIds, @RequestParam("buildingId") Long buildingId) {
		ModelAndView mav = new ModelAndView("redirect:/admin/building-list");
