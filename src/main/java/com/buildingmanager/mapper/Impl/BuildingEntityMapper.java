...
//
//public class BuildingEntityMapper implements RowMapper<BuildingEntityCustom> {
//
//	@Override
//	public BuildingEntityCustom rowMapper(ResultSet result) {
//		try {
//			BuildingEntityCustom building = new BuildingEntityCustom();
