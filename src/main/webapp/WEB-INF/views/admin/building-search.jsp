				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="widget-box">
							...
							<form action="${buildingSearchUrl }" method="get"
								id="formSearchBuilding" class="widget-body">
								<div class="widget-main">
									<div class="row">
										<div class="col-sm-6">
											<label for="name" class="form-label"><b>Tên sản
													phẩm</b></label> <input type="text" class="form-control" id="name"
												name="name">
										</div>
										<div class="col-sm-6">
										...
										<div class="col-sm-4">
											...
											<div class="form-group">
												<select id="rentType" class="multiselect"
													...
													<option value="" selected>-- Chọn loại toà nhà --</option>
									...
									<div class="row">
										<div class="col-sm-3">
											<label for="rentAreaFrom" class="form-label"><b>Diện
													tích từ</b></label> <input type="text" class="form-control"
												id="rentAreaFrom" name="rentAreaFrom">
										</div>
										<div class="col-sm-3">
											<label for="rentAreaTo" class="form-label"><b>Diện
													tích đến</b></label> <input type="text" class="form-control"
												id="rentAreaTo" name="rentAreaTo">
										</div>
										<div class="col-sm-3">
											<label for="rentPriceFrom" class="form-label"><b>Giá
													thuê từ</b></label> <input type="text" class="form-control"
												id="rentPriceFrom" name="rentPriceFrom">
										</div>
										<div class="col-sm-3">
											<label for="rentPriceTo" class="form-label"><b>Giá
													thuê đến</b></label> <input type="text" class="form-control"
												id="rentPriceTo" name="rentPriceTo">
										</div>
									</div>
									<br>
									<div class="row">
										...
										<div class="col-sm-4">
											<label for="managerPhone" class="form-label"><b>Điện
													thoại quản lý</b></label> <input type="text" class="form-control"
												id="managerPhone" name="managerPhone">
										</div>
										<div class="col-sm-4">
											<label for="staffId" class="form-label"><b>Chọn
													nhân viên phụ trách</b></label><br> <select name="staffId"
												id="staffId">
